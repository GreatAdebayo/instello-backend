...
const verificationcode_service_1 = require("./verificationcode.service");
...
VerificationModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [],
        providers: [verificationcode_service_1.VerficationService],
        exports: [verificationcode_service_1.VerficationService]
    })
], VerificationModule);
exports.VerificationModule = VerificationModule;
//# sourceMappingURL=verificationcode.module.js.map